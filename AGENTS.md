...
- Start with status, list, or metadata search. Retrieve transcript pages only when the user explicitly requests the selected meeting and approves the tool call.
